...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.show_download_link'
        db.add_column(u'vikalp_article', 'show_download_link',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.show_download_link'
        db.delete_column(u'vikalp_article', 'show_download_link')
    ...
    models = {
        ...
        u'vikalp.article': {
            ...
            'show_download_link': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
