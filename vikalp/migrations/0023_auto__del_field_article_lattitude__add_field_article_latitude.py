...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.lattitude'
        db.delete_column(u'vikalp_article', 'lattitude')

        # Adding field 'Article.latitude'
        db.add_column(u'vikalp_article', 'latitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Article.lattitude'
        db.add_column(u'vikalp_article', 'lattitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7),
                      keep_default=False)

        # Deleting field 'Article.latitude'
        db.delete_column(u'vikalp_article', 'latitude')
