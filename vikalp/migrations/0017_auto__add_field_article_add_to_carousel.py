...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.add_to_carousel'
        db.add_column(u'vikalp_article', 'add_to_carousel',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.add_to_carousel'
        db.delete_column(u'vikalp_article', 'add_to_carousel')
    ...
    models = {
        ...
        u'vikalp.articlecategory': {
            ...
            'category_image': ('django.db.models.fields.files.ImageField', [], {'default': "'/static/img/livelihood.png'", 'max_length': '100'})
        }
    }
