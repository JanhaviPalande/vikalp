...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleCategory.category_long_description'
        db.add_column(u'vikalp_articlecategory', 'category_long_description',
    ...
    def backwards(self, orm):
        # Deleting field 'ArticleCategory.category_long_description'
        db.delete_column(u'vikalp_articlecategory', 'category_long_description')


        # Changing field 'ArticleCategory.category_description'
        db.alter_column(u'vikalp_articlecategory', 'category_description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'vikalp.articlecategory': {
            ...
            'category_description': ('django.db.models.fields.TextField', [], {'max_length': '128'}),
