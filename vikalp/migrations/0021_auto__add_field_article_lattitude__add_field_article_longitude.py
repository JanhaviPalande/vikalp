...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.longitude'
        db.add_column(u'vikalp_article', 'longitude',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Article.longitude'
        db.delete_column(u'vikalp_article', 'longitude')
    ...
    models = {
        ...
        u'vikalp.article': {
            ...
            'lattitude': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
