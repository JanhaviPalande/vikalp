...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APost'
        db.create_table(u'vikalp_apost', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('apostFields', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['blog.BlogPost'], unique=True)),
        ))
        db.send_create_signal(u'vikalp', ['APost'])


    def backwards(self, orm):
        # Deleting model 'APost'
        db.delete_table(u'vikalp_apost')
    ...
    models = {
        ...
        u'vikalp.apost': {
            'Meta': {'object_name': 'APost'},
            'apostFields': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['blog.BlogPost']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'vikalp.article': {
