...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'vikalp_article', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=31, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.content_type'
        db.delete_column(u'vikalp_article', 'content_type_id')
    ...
    models = {
        ...
        u'vikalp.article': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'default': '31', 'to': u"orm['contenttypes.ContentType']"}),
