...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleCategory.category_image'
        db.add_column(u'vikalp_articlecategory', 'category_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='/vagrant/vikalp/static/img/livelihood.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleCategory.category_image'
        db.delete_column(u'vikalp_articlecategory', 'category_image')
    ...
    models = {
        ...
        u'vikalp.articlecategory': {
            ...
            'category_image': ('django.db.models.fields.files.ImageField', [], {'default': "'/vagrant/vikalp/static/img/livelihood.png'", 'max_length': '100'})
        }
    }
