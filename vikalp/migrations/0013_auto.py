...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field article_categories on 'Article'
        m2m_table_name = db.shorten_name(u'vikalp_article_article_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm[u'vikalp.article'], null=False)),
            ('articlecategory', models.ForeignKey(orm[u'vikalp.articlecategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['article_id', 'articlecategory_id'])


    def backwards(self, orm):
        # Removing M2M table for field article_categories on 'Article'
        db.delete_table(db.shorten_name(u'vikalp_article_article_categories'))
    ...
    models = {
        ...
        u'vikalp.articlecategory': {
            ...
            'category_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'})
        }
    }
