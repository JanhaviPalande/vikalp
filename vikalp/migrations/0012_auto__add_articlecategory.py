...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vikalp_articlecategory', (
            (u'blogcategory_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['blog.BlogCategory'], unique=True, primary_key=True)),
            ('category_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('category_description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'vikalp', ['ArticleCategory'])


    def backwards(self, orm):
        # Deleting model 'ArticleCategory'
        db.delete_table(u'vikalp_articlecategory')
