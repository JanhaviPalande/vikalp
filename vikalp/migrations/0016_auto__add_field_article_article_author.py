...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.article_author'
        db.add_column(u'vikalp_article', 'article_author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.article_author'
        db.delete_column(u'vikalp_article', 'article_author')
