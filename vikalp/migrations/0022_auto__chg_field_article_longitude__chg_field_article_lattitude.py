...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.longitude'
        db.alter_column(u'vikalp_article', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7))

        # Changing field 'Article.lattitude'
        db.alter_column(u'vikalp_article', 'lattitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7))

    def backwards(self, orm):

        # Changing field 'Article.longitude'
        db.alter_column(u'vikalp_article', 'longitude', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Article.lattitude'
        db.alter_column(u'vikalp_article', 'lattitude', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'vikalp.article': {
            'Meta': {'ordering': "('-publish_date',)", 'object_name': 'Article', '_ormbases': [u'blog.BlogPost']},
            'add_to_carousel': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'article_author': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'article_categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'articles'", 'blank': 'True', 'to': u"orm['vikalp.ArticleCategory']"}),
            u'blogpost_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['blog.BlogPost']", 'unique': 'True', 'primary_key': 'True'}),
            'lattitude': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '7'}),
        ...
        u'vikalp.articlecategory': {
            'Meta': {'ordering': "('title',)", 'object_name': 'ArticleCategory', '_ormbases': [u'blog.BlogCategory']},
            u'blogcategory_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['blog.BlogCategory']", 'unique': 'True', 'primary_key': 'True'}),
            'category_description': ('django.db.models.fields.TextField', [], {'max_length': '100'}),
            'category_image': ('django.db.models.fields.files.ImageField', [], {'default': "'img/default.png'", 'max_length': '100'}),
            'category_long_description': ('django.db.models.fields.TextField', [], {'default': "''"})
        }
    }

    complete_apps = ['vikalp']