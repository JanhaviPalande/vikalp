...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArticleCategory.category_long_description'
        db.alter_column(u'vikalp_articlecategory', 'category_long_description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ArticleCategory.category_description'
        db.alter_column(u'vikalp_articlecategory', 'category_description', self.gf('django.db.models.fields.TextField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ArticleCategory.category_long_description'
        db.alter_column(u'vikalp_articlecategory', 'category_long_description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ArticleCategory.category_description'
        db.alter_column(u'vikalp_articlecategory', 'category_description', self.gf('django.db.models.fields.TextField')(max_length=128))
    ...
    models = {
        ...
        u'vikalp.articlecategory': {
            ...
            'category_long_description': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'})
        }
    }
