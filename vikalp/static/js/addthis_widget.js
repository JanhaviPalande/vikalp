        ...
        setTimeout(function () {
            if (!window.addthis.timer.core) {
                ...
                if (_atc.cdn !== 0) {
                    var d = document.createElement("script");
                    d.type = "text/javascript";
                    d.src = (s ? "https:" : "http:") + _atr + "static/r07/core118.js";
                    h.appendChild(d);
                }
            }
        }, m);
